...
//		$(this).css("background-color", "#ffaa00");
		$(this).css("background-color", "#cfe8f3");	// SC用
	...
	if(json.type == "INIT_DOCUMENT"){
		...
		if($("div#mi_docment_area").is(':visible') && currentDocumentId != 0){
			...
			if(json.writeLineFlg){
				// 線を描いた人の比率と自分の比率を考慮し計算を行う
				writeLine("document_canvas", proportionDrowX, proportionDrowY, proportionOnMouseX, proportionOnMouseY, json.line, json.color, json.selectLeftTool);
			}
		}
