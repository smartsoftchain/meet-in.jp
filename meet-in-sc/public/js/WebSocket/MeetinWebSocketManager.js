...
(function (MeetinWebSocketManager) {
	...
	// URL
	const WEB_SOCKET_HOST = 'wss://' + location.hostname + ':' + WEB_SOCKET_PORT + "/ws/";
...
TraceLog(null ,null ,0 ,'[MeetinWebSocket][init][errorCallbackWork]:event='+JSON.stringify(event),null,null,null);
