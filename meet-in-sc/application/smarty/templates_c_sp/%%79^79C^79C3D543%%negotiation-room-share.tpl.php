<?php /* Smarty version 2.6.26, created on 2020-09-04 12:59:56
         compiled from ./negotiation/negotiation-room-share.tpl */ ?>
<div class="modal_share_room" id="modal_share_room">
	<div id="meetin_room_name" hidden=""><?php echo $this->_tpl_vars['room_name']; ?>
</div>
	...
	<div class="room_url_label">
		<span id="meetin_room_url"><?php echo $this->_tpl_vars['serverAddress']; ?>
/room/<?php echo $this->_tpl_vars['room_name']; ?>
