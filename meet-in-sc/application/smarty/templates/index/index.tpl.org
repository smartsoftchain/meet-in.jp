...
<meta charset="utf-8">
<meta name="description" content="meet in（ミートイン）は、いつでも、どこでも簡単にweb会議ができる、オンラインコミュニケーションプラットフォームです。アプリのインストールは不要、すぐに始められます。">
   ...
   $(window).scroll(function(){
		 ...
		 if(scr_count > nav_t_pos){
		  ...
		  $('.mi_nav_active').removeClass('mi_nav_active');
			...
			if(scr_count > company_t_pos && scr_count < topic_t_pos ) {
				$('.mi_js_scroll li:nth-child(8) a').addClass('mi_nav_active');
			}
			if (scr_count > member_t_pos && scr_count < company_t_pos ) {
				$('.mi_js_scroll li:nth-child(7) a').addClass('mi_nav_active');
			}
			if (scr_count > plan_t_pos && scr_count < member_t_pos ) {
			...
			if (scr_count > vido_t_pos && scr_count < case_t_pos ) {
				$('.mi_js_scroll li:nth-child(4) a').addClass('mi_nav_active');
			}
			if (scr_count > chara_t_pos && scr_count < vido_t_pos ) {
				$('.mi_js_scroll li:nth-child(3) a').addClass('mi_nav_active');
			}
			if (scr_count > vision_t_pos && scr_count < chara_t_pos ) {
				$('.mi_js_scroll li:nth-child(2) a').addClass('mi_nav_active');
			}
			if (scr_count > 0 && scr_count < vision_t_pos ) {
				$('.mi_js_scroll li:first-child a').addClass('mi_nav_active');
			}
   })
})
	...
	<div id="mi_top_visual" class="mi_clearfix mi_top_visual">
		...
		<div class="mi_top_visual_inner">
			...
			<div class="mi_connect_from">
				<div class="mi_connect_from_inner">
					...
					<p class="mi_atentsion_text">担当者がお伝えした番号を11桁で入力し、meet inへ接続してください。</p>
					<p class="mi_input_text">meet in番号（11桁）</p>
					<input type="text" id="connect_no" value="{$connect_no}" placeholder="000-0000-0000" class="mi_default_input" with data-grouplength="3,4,4">
					<p class="mi_input_text">氏名（任意）</p>
					<input type="text" id="user_info" value="{$user_info}" placeholder="山田 太郎" class="mi_default_input mi_second_input">
					<button type="button" name="button" class="mi_default_button mi_conect_button hvr-fade" id="connect">接 続</button>
		...
		<nav class="mi_lpmain_nav_wrap">
			<div id="mi_lp_top_nav" class="mi_lpmain_nav">
				<ul class="mi_lpmain_nav_inner mi_js_scroll mi_clearfix">
					...
					<li><a href="#mi_vido_section">利用方法</a></li>
					<li><a href="#mi_case_section">活用方法</a></li>
					<li><a href="#mi_plan_section">料金プラン</a></li>
					<li><a href="#mi_member_section">メンバー</a></li>
			...
			<div class="mi_top_section_inner mi_chara_inner">
				...
				<div class="mi_chara_section_nav">
					<ul class="mi_cahra_link_list mi_clearfix">
						<li><a href="#mi_chara_block01" class="mi_cahra_link_purple">
				...
				<div id="mi_chara_block01" class="mi_chara_block mi_clearfix">
					<div class="mi_detail_wrap mi_flt-l">
						...
						<p class="mi_text_bold">アプリのダウンロードや<br>
							ログイン・固定回線は一切不要。</p>
						<p class="mi_detail_text">meet inの入力フォームにミーティング相手のナンバーを入力するだけ。世界中どこにいてもパソコンやタブレットが1台あればいつでもmeet in。</p>
						<p class="mi_text_caution">※入力フォームはmeet inを活用している会社のホームページにもついています。</p>
						<ul class="mi_checkList mi_clearfix">
							<li class="mi_checkList_borderpurple tool_login_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="login_modal" class="modal_open tool_login"><img src="/img/lp/tool-login.png" class="js_img_chenge" alt="ログイン不要"></a></p>
							</li>
							<li class="mi_checkList_borderpurple tool_namber_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="namber_modal" class="modal_open tool_namber"><img src="/img/lp/tool-namber.png" class="js_img_chenge" alt="固定meet in番号"></a></p>
							</li>
							<li class="mi_checkList_borderpurple tool_talk_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="talk_modal" class="modal_open tool_talk"><img src="/img/lp/tool-talk.png" class="js_img_chenge" alt="ブラウザだけで会話可能"></a></p>
							</li>
						</ul>
					</div>
				...
				<div id="mi_chara_block02" class="mi_chara_block mi_clearfix">
					<div class="mi_detail_wrap mi_flt-r">
						...
						<ul class="mi_checkList mi_clearfix">
							<li class="mi_checkList_borderorange tool_video_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="video_modal" class="modal_open tool_video"><img src="/img/lp/tool-video.png" class="js_img_chenge" alt="ワンクリック録画"></a></p>
							</li>
							<li class="mi_checkList_borderorange tool_memo_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="memo_modal" class="modal_open tool_memo"><img src="/img/lp/tool-memo.png" class="js_img_chenge" alt="リアルタイム共有メモ"></a></p>
							</li>
							<li class="mi_checkList_borderorange tool_shear_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="shear_modal" class="modal_open tool_shear"><img src="/img/lp/tool-shear.png" class="js_img_chenge" alt="瞬間資料共有"></a></p>
							</li>
						</ul>
					</div>
				...
				<div id="mi_chara_block03" class="mi_chara_block mi_clearfix">
					<div class="mi_detail_wrap mi_flt-l">
						...
						<ul class="mi_checkList mi_clearfix">
							<li class="mi_checkList_borderpurple tool_maishi_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="maishi_modal" class="modal_open tool_maishi"><img src="/img/lp/tool-maishi.png" class="js_img_chenge" alt="名刺交換機能"></a></p>
							</li>
							<li class="mi_checkList_borderpurple tool_pc_tab_sp_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="tool_pc_tab_sp_modal" class="modal_open tool_pc_tab_sp"><img src="/img/lp/tool-pc-tab-sp.png" class="js_img_chenge" alt="PC・タブレットスマホ対応"></a></p>
							</li>
							<li class="mi_checkList_borderpurple tool_cloud_bk">
								<p class="mi_checkList_title"><a href="javascript:void(0)" id="cloud_modal" class="modal_open tool_cloud"><img src="/img/lp/tool-cloud.png" class="js_img_chenge" alt="新機能随時追加"></a></p>
							</li>
						</ul>
					</div>
		...
		<section id="mi_case_section" class="mi_top_section mi_case_section">
              ...
              <div class="mi_case_list_text_bb"></div>
							<div class="mi_case_hiddenText">営業パーソンの営業効率は<span class="mi_case_pointColor">3倍</span>に</div>
						</div>
					</a></li>
		...
		<section id="mi_plan_section" class="mi_top_section mi_plan_section">
			<div class="mi_top_section_inner mi_plan_inner">
				<div class="mi_top_section_title_block">
					<h2 class="mi_top_section_title mi_title_line_orange">料金プラン</h2>
				</div>
				<ul class="mi_plan_list mi_clearfix">
					<li class="mi_plan_type_warp">
						<div class="mi_plan_type">
							...
							<p class="mi_plan_type_text"><span class="mi_plan_type_text_s">1ユーザー</span>3,980円</p>
						</div>
            ...
            <p class="mi_plan_atention_text">※別途、管理者用アカウント<br>
              月額9,800円がかかります。</p>
...
担当者より追って詳細のご案内をさせていただきます。</p>
			...
			<div class="mi_overlay_wrap mi_overlay_privacy_wrap">
				<div class="mi_overlay_contents mi_privacy_block">
					...
					<div class="mi_overlay_contents_title mi_privacy_title_wrap">
						<img src="/img/lp/ico-pra.png" class="mi_privacy_title_img" alt="プライバシーマーク">
		...
		<div id="mi_overlay_confirm" class="mi_overlay mi_overlay_confirm">
          ...
          <form action="/lp/complete.php" method="post" class="mi_confirm_form">
            <input type="hidden" name="confirm_name" class="mi_confirm_name_input">
            <input type="hidden" name="confirm_company" class="mi_confirm_company_input">
            <input type="hidden" name="confirm_tel" class="mi_confirm_tel_number_input">
            <input type="hidden" name="confirm_mail" class="mi_confirm_mail_input">
            <input type="hidden" name="confirm_contact" class="mi_confirm_contact_input">
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_01" class="mi_modal_wrap talk_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-talk-m.png" class="mi_char_modal_img" alt="ブラウザーだけで共有可能">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">固定回線不要・<br>
ブラウザだけで会話可能</p>
					<p class="mi_modal_chara_text">パソコンやスマートフォンがあればデバイス間ですぐに会話ができます。カメラが付いていなくても、音声での会話や資料の共有などに問題はありません。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_02" class="mi_modal_wrap maishi_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-maishi-m.png" class="mi_chara_modal_img" alt="名刺交換機能">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">オンライン上で<br>
名刺の交換ができます</p>
					<p class="mi_modal_chara_text">あらかじめ名刺情報を登録しておくことで対話相手と名刺交換ができます。初めて会う方ともスムーズにコミュニケーションを始めることができます。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_03" class="mi_modal_wrap shear_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-shear-m.png" class="mi_chara_modal_img" alt="瞬間資料共有">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">画面にドラック&amp;ドロップで<br>
資料がすぐに共有できます
</p>
					<p class="mi_modal_chara_text">共有メモに入力すると同じ情報がリアルタイムにゲストの画面に表示されます。音声だけでなくスケジュールや決定事項に不備がないか文字で共有することができます。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_04" class="mi_modal_wrap memo_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-memo-m.png" class="mi_chara_modal_img" alt="リアルタイム共有メモ">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">ゲストと同時に<br>
メモを編集できる</p>
					<p class="mi_modal_chara_text">共有メモに入力すると同じ情報がリアルタイムにゲストの画面に表示されます。音声だけでなくスケジュールや決定事項に不備がないか文字で共有することができます。</p>
				</div>
			</div>
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_05" class="mi_modal_wrap tool_pc_tab_sp_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-pc-tab-sp-m.png" class="mi_chara_modal_img" alt="PC・タブレットスマホ対応">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">デバイスを選ばないから、<br>
どこでも利用可能</p>
					<p class="mi_modal_chara_text">PCだけでなく、モバイル端末でも利用ができます。突然の会議や連絡だけでなく、自宅やカフェなど場所を選ばずにコミュニケーションを取ることができます。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_06" class="mi_modal_wrap cloud_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-cloud-m.png" class="mi_chara_modal_img" alt="新機能随時追加">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">クラウドサービスだから<br>
更新不要で新機能が使える</p>
					<p class="mi_modal_chara_text">Webサービスなので、新機能が追加されたら更新不要ですぐに利用ができます。コミュニケーションに欠かせない便利な機能を今後も追加予定！</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_07" class="mi_modal_wrap namber_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-namber-m.png" class="mi_chara_modal_img" alt="固定meet in番号">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">何度でも使える<br>
固定meet in番号</p>
					<p class="mi_modal_chara_text">1人につき1つ何度でも使える固定meet in番号が付与されます。支社間でのミーティグなど何度もコミュニケーションをとる場合に大変便利です。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_08" class="mi_modal_wrap login_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-login-m.png" class="mi_chara_modal_img" alt="ログイン不要">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">ログイン不要で<br>
すぐにつながる</p>
					<p class="mi_modal_chara_text">ゲストはオペレーターが発番した11桁のmeet in番号をwebサイト上に入力するだけで即座にオンラインコミュニケーションを始めることができます。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
		...
		<!-- LPプライバシーポップアップコンテンツコンテンツ begin -->
		<div id="mi_modal_01" class="mi_modal_wrap video_modal">
			<div class="mi_modal_shadow"></div>
			<div class="mi_modal_contents mi_clearfix">
				<div class="mi_modal_block mi_modal_img_wrap mi_flt-l">
					<img src="/img/lp/tool-video-m.png" class="mi_chara01_modal_img" alt="ワンクリック録画">
				</div>
				<div class="mi_modal_block mi_modal_text_wrap mi_flt-r">
					<p class="mi_modal_chara_title">いつでも簡単に<br>
対話を録画できます</p>
					<p class="mi_modal_chara_text">残しておきたいゲストとの対話は、画面にあるボタンひとつですぐに録画&amp;ダウンロードできます。商談を振り返ったり、議事録に利用できます。</p>
				</div>
			</div>
		</div>
		<!-- LPプライバシーコンテンツ end -->
