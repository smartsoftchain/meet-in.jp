...
<html lang="ja">
	...
	<body>
		...
		<div id="mi_wrap">
			...
			<div id="mi_wrap">
				...
				<div id="mi_main_contents">
					...
					<div id="mi_content_area_negotiation" ondragover="materialDragOver(event)" ondrop="materialDrop(event)" >
						...
						{include file="./negotiation/negotiation-secret-memo.tpl"}
			...
			<input type="hidden" id="Referer_host" value="{$referer_host}"/>
			...
			<script type="text/javascript" src="/js/negotiation/negotiation_room_share.js?{$application_version}"></script>
