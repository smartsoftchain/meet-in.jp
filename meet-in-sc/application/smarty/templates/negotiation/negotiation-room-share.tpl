...
.negotiation_modal_close {
  background: #35a0d4 url(../img/btn_close.png) no-repeat center center;
	position: absolute;
  top: 0px;
  right: 0px;
  display: block;
  ...
  height: 40px;
	...
	.negotiation_modal_close:hover { background-color: #cfe8f3;}
...
<div class="negotiation_modal_roomshare">
  <div id="meetin_room_name" hidden="">{$room_name}</div>
	...
	<div class="room_url_label">
      ...
      <!--https://online.sales-crowd.jp/room/xxxxxxxx-->
    </span>
	</div>
