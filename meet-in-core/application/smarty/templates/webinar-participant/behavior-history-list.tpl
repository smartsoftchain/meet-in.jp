...
<div id="mi_main_contents">
	...
	<div id="mi_top_nav">
		...
		<div class="mi_breadcrumb_list">
			...
			<a href="/webinar-participant/detail?webinarId={$webinarId}&id={$webinarParticipantId}">参加者詳細</a>&nbsp;&gt;&nbsp;
			参加者行動履歴一覧
		</div>
		<!-- パンくずリスト end -->
	</div>
	...
	<div id="mi_content_area">
		...
		<div class="webinar_detail_tab_area">
			<div class="webinar_detail_tab width120 current_webinar_detail_tab">行動履歴</div>
			<a href="/webinar-participant/detail?webinarId={$webinarId}&id={$webinarParticipantId}"><div class="webinar_detail_tab width120">概要</div></a>
		</div>
		...
		<div class="mi_content_title">
			<div class="webinar_list_search_area">
				<form id="search_form" action="/webinar-participant/behavior-history-list" method="get">
			...
			<div class="mi_flt-r">
				<div class="mi_content_title_option">
					<a href="javascript:void(0);" name="lnk_delete_participant_behavior_history" class="mi_title_action_btn del_chk click-fade" id="del_chk">
						...
						<tr>
							...
							<td class="text_align_left">
								{if $row.send_mail_flg}
									<a href="javascript:void(0);" class="lnk_history_mail show-modal-mail-detail" id="{$row.webinar_id}_{$row.webinar_participant_id}_{$row.id}" data-display-type="participant">
										{$row.mail_subject}
									</a>
								{else}
									{$row.mail_subject}
