...
<div id="mi_main_contents">
  ...
  <div id="mi_content_area">
    ...
    <div class="mi_content_title">
      ...
      <h1>電子契約書一覧</h1>
      <div class="mi_flt-r">
        <form id="search_form" action="/e-contract-api/partner-completed" method="get">
      ...
      <div class="button_wrap">
        ...
        <div class="button-box-complete" id="button-box-complete-id">
          <div class="complete_button">
            <a href="https://{$serverAddress}/e-contract-api/partner-completed"class="button_text-complete">完了　({$list->getCount()}件)</a>
          </div>
        </div>
