...
<script type="text/javascript" src="/js/sp/negotiation/mcu/meeting.js?{$application_version}"></script>
...
<script src="/js/sp/negotiation/mcu/share_memo.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/write_line.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/white_board.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/chat_board.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/meetin_db.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/material_upload.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/negotiation_sync.js?{$application_version}"></script>
<script src="/js/less.min.js?{$application_version}" type="text/javascript"></script>
<script src="/js/sp/negotiation/mcu/negotiation_namecard.js?{$application_version}"></script>
<script src="/js/platform.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/e_contract.js?{$application_version}"></script>
<script src="/js/sp/negotiation/mcu/audio_text.js?{$application_version}"></script>
	...
	<div class="content__wrap iphonex_safe_area" id="content__wrap">
		<div class="full_screen__wrap">
			...
			<div class="video_area_wrap">
				...
				{include file="./negotiation/mcu/negotiation-mcu-video.tpl" video_id='99'}

				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='0' this_id=$user_id}
				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='1' this_id=$user_id}
				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='2' this_id=$user_id}
				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='3' this_id=$user_id}
				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='4' this_id=$user_id}
				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='5' this_id=$user_id}
				{include file="./negotiation/mcu/negotiation-target-video.tpl" video_id='6' this_id=$user_id}
		...
		<div class="nonReccomendModal">
			<div class="non_reccomend_main">
				...
				<div class="non_reccomend_link_wrap">						
					設定に関する詳細は<a href="https://manual.meet-in.jp/?p=540" target="_blank" rel="noopener" class="non_reccomend_link">こちら</a>
				</div>
...
<!--
 ...
 -->
		...
		<!-- コネクト begin -->
		{include file="./negotiation/mcu/loading.tpl"}
		<!-- コネクト end -->
	...
	<script src="/js/mcu/librarys/owt/adapter.js?{$application_version}" defer></script>
	...
	<script src="/js/negotiation.sp.js?{$application_version}" defer></script>
...
<!-- MCU -->
	...
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_manager.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_common.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_init.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_reconnect.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_camera.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_mic.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_screen.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_command_receive.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_interface_command_send.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_video.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_main.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_event_func.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_enter_room.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_exit_room.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_setting_camera.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_extra_function.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/get_oldest_user_id.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/material.js?{$application_version}"></script>
	<script type="text/javascript" src="/js/sp/negotiation/mcu/negotiation_login.js?{$application_version}"></script>
	{* 文字起こし関連 begin *}
