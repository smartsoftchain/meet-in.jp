<!-- 名刺表示 start -->
{literal}
<link rel="stylesheet" href="/css/namecard.css" media="screen and (max-width:960px)">
<script>
$(function (){
	// 名刺PDFクリック
	...
	<div class="mi_namecard_detail" id="mi_namecard_detail">
		<div class="feature-list">
				...
				<div class="mi_namecard_detail_content" id="namecard_staff_info">
					...
					<div class="contents">
						...
						<div class="contents_small">
							...
							<a href="" id="namecard_mailto" class="namecard_url_href" onclick="namecard_mailto(); return false;" value="{{namecard_email}}">{{showEmail namecard_email 30}}</a>
							{{/if}}
							{{#if namecard_url}}
							<div>
			...
			<div class="feature-item">
				...
				<div class="mi_namecard_detail_content">
						<div>
							<p class="namecard-text-area">{{namecard_introduction}}</p>
						</div>
				</div>
			</div>
	</div>
