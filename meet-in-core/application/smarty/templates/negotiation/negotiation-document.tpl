	...
	<div id="mi_docment_scroll" style="width:100%;height:100%">
		...
		<div id="document_canvas_area" class="document_canvas_area" style="z-index:auto;">
			<div class="document_canvas_contents">
				...
				<div id="document_text_field">
					<div id="document_text_input_trigger" style="width:100%;height:100%;position: absolute;"></div>
				</div>
		...
		<div id="mi_docment_zoom">
			...
			<div id="document_download" class="document_controller_btn">
				<div class="icon-send-document mi_btn_icon_" style="margin-top:10px"></div>
				<div class="mi_icon_text" style="font-size:8px; line-height:12px; text-align:center;">資料<br>を送る</div>

				<div id="document_download_option">
					<ul>
						<li id="document_send_download" class="document_download_options">相手に資料を送る</li>
						<li id="document_own_download" class="document_download_options">自分がダウンロードする</li>
					</ul>
				</div>
			</div>
		</div>
...
$(document).ready(function(){
	...
	// ipadPCの場合に、資料ダウンロード選択肢のスタイルを調整する
	if (USER_PARAM_IS_IPAD_PC) {
		$('.document_download_options').css({
			'height': '50px',
			'width': '200px'
		});
	}
