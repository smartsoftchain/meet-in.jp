	...
	{/if}
		...
		<div class="mi_table_main_wrap mi_table_input_right_wrap setting-video-input-group" style="min-height: auto;">
			<table class=" setting_table">
				...
				{if $browser === 'IE'}
				<tr>
					<th class="setting_th textalign_center">最大フレームレート(1～30)</th>
					<td class="setting_td" style="height: 42px;">
						<input type="range" name="fpsrate" min="1" max="30" step="1" id="video-setting-framerate" style="width: 280px; border: none;" class="setting_range_flash">&nbsp;&nbsp;
				...
				<tr>
					<th class="setting_th textalign_center">最大フレームレート(1～30)</th>
					<td class="setting_td" style="height: 42px;">
						<input type="range" name="fpsrate" min="1" max="30" step="1" id="video-setting-framerate" style="width: 280px; border: none;">&nbsp;&nbsp;
						<span id="framerate-value"></span>
					</td>
				</tr>
				{/if}
