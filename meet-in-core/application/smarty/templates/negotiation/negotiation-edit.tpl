	...
	<div id="mi_content_area">
		...
		<div class="mi_content_title">
			...
			<div class="mi_flt-r">
				<div class="mi_content_title_option">
					<a href="/negotiation/download-csv?id={$BDRDict.id}&time={$time}" class="mi_title_action_btn">
        ...
        <table class="mi_table_input_right mi_table_main">
					<tbody>
						...
						<tr>
							<td class="mi_tabel_title_2_rows">
								<p>録画ダウンロードURL</p>
								<p class="reminder">※保存期間は10日間です。</p>
							</td>
							<td class="txtinp mi_tabel_content download_url">
								{if $BDRDict.is_file_exists && !$BDRDict.is_file_bucket_exists }録画ファイル作成中・・・{else}
