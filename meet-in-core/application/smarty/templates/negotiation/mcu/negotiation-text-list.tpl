...
<div id="mi_main_contents">
    ...
    <div id="mi_content_area">
        ...
        <div class="mi_text_content_title">
            ...
            <img src="/img/audio_text3.png" class="text_audio_icon">
            <h1>文字起こしファイル一覧</h1>
            <div class="mi_flt-r">
				<div class="mi_content_title_option">
					{if ($user.staff_role == "AA_1" || $user.staff_role == "AA_2" || $user.staff_role == "CE_1" || ($user.staff_role == "CE_2" && $user.client_id == "1027"))}
