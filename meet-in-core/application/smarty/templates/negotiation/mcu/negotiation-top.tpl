...
<header style="z-index:99999999;">
  ...
  <div class="mi_flt-l">
    ...
    {if $browser !== 'IE' || $browser !== 'FireFox' || $browser !== 'Safari'}
    <button id="togglePipButton" class="pip_tooltip" style="display: none;">
      <span class="pip_textarea">
        <img src="/img/PinP4.svg" style="width: 20px;" id="pip_status_icon">
        <p id="pip_text">サブフレーム</p>
        </span>
      </span>
    </button>
    {/if}
    <div class="mi_header_users">
      <div class="mi_header_status_reset" id="header_video_reset">
          <img class="reset_btn" src="/img/header/icon_video_reset.svg"> 配置を初期に戻す
      </div>
    </div>
    <!-- 同席モードの通知 begin -->
    {if $room_mode == 2}
  ...
  　</div>
    ...
    <div class="mi_elapsed_time mi_login_header" style="width:160px; padding: 0 6px;">経過時間 <span id="time">00:01:21</span></div>
    {else}
    <div class="mi_elapsed_time mi_login_header" style="width:130px; padding: 0 6px;">経過時間 <span id="time">00:01:21</span></div>
...
<!-- カメラ設定 start -->
{include file="./negotiation/mcu/negotiation-setting-camera.tpl"}
<!-- カメラ設定 end -->
<!-- Bodypix設定 start -->
