...
<title>meet in（ミートイン） | ログインページ</title>
<meta charset="utf-8">
<meta name="description" content="meet in（ミートイン）に管理者用アカウントのログインページです。">
...
<div id="mi_wrap">
  ...
  <header id="login_header">
	...
	<div id="mi_admin_login_form">
		...
		<div class="mi_half_background mi_img_slide_wrap">
			<div class="mi_img_slide_wrap_inner">
				...
				<div class="mi_img_slide_list mi_login_let_img_2"></div>
				<div class="mi_img_slide_list mi_login_let_img_3"></div>
				<div class="mi_img_slide_list mi_login_let_img_4"></div>
			</div>
		</div>
		...
		<div class="mi_half_background mi_admin_login_form_wrap">
          ...
          <img src="/img/logo_h50-2.png" alt="meet in" class="mi_logo_image"/>
					...
					<form action="/index/login" method="post" name="login_form">
						<label for="id"><span>ID</span><input type="text" name="id" value="" placeholder="AA000000" class="mi_default_input input_text_upper" /><br></label>
	...
	<!-- フッター start -->
	<footer>
		<span class="mi_copyright">meet in Inc. All Rights Reserved {$application_version}</span>
	</footer>
	<!-- フッター end -->
