			...
			<h1>資料ファイル一覧</h1>
				...
				<div class="mi_flt-r">
					<div class="mi_content_title_option">
						...
						{if ($user.staff_role == "AA_1" || $user.staff_role == "AA_2" || $user.staff_role == "CE_1" || ($user.staff_role == "CE_2" && $user.client_id == "1027") || $user.delete_general_authority_flg || ($user.staff_role == "CE_2" && $user.delete_general_authority_flg == 1))}
	...
	-->
		...
		<div class="mi_pagenation">
			<div class="file_count_wrap">
				{if ($user.staff_role == "AA_1" || $user.staff_role == "AA_2" || $user.staff_role == "CE_1" || ($user.staff_role == "CE_2" && $user.client_id == "1027") || $user.delete_general_authority_flg || ($user.staff_role == "CE_2" && $user.delete_general_authority_flg == 1))}
					<span class="file_all_delete">
						<input type="checkbox" onchange="file_all_delete();" id="file_all_delete">
						<label for="file_all_delete">一括削除</label>
					</span>
				{/if}
