				...
				<div>
					<div class="mi_header_select mi_user_detail">
						...
						<ul class="mi_select_option">
							...
							{if $user.admin_header_enable}
								...
								<li>
									<a href="/admin/document-settings-background">
										<span class="mi_default_label_icon icon-photo-orange"></span><div>背景設定</div>
									</a>
								</li>
								{/if}
							{/if}
							...
							{/if}
							{if !empty($user.client_type) && $user.client_type == "2" && ($user.staff_role == "AA_1" || $user.staff_role == "CE_1" || $user.staff_role == "CE_2") && $user.admin_header_enable}
					...
					{if !empty($user.client_id) && $user.plan_this_month > 1}
                        <li class="hvr-underline-from-center mi_header_select mi_user_detail hvr-underline-from-center--headerMenu {if $controllerName == 'negotiation'} active{/if}">
							...
							<ul class="mi_select_option history">
								<li><a href="/negotiation/negotiation-list" class="fontsize_12"><span class="icon-history mi_default_label_icon" id="icon-history" style="color:#e09500; margin-top: 0px;"></span><div>接続履歴一覧</div></a></li>
								<li><a href="/negotiation/negotiation-text-list" class="fontsize_12"><img class="option_icon" src="/img/audio_text3.png"><div>文字起こしファイル一覧</div></a></li>
								<li class="audio_analysis_display_menu"><a href="/analysis-audio/show-audio-data-list" class="fontsize_12"><img class="form_arrow_icon  option_icon" src="/img/audio-analysis.svg"></span><div>音声分析一覧</div></a></li>
								<li class="audio_analysis_display_menu"><a href="/analysis-audio/analysis" class="fontsize_12"><img class="form_arrow_icon search_modal_form   option_icon" src="/img/audio-analysis.svg"><div>音声データ集計</div></a></li>

								{if $user.client_id == "1" && ($user.staff_type == "AA" || $user.staff_type == "CE") && $user.record_method_type !== '1'}
