		...
		<section class=" mi_contact_section mi_bg_orange webinar_participant_form_background" id="mi_contact_section">
			<div class="mi_top_section_inner">
				<div class="mi_top_section_title_block">
					<h2 class="mi_top_section_title mi_contact_title" style="color: #333;">ウェビナーへ参加申請が完了しました。</h2>
				</div>
				<p class="mi_contact_subtitle" style="color: #333;">入力したメールアドレスへ、メールを送信しましたのでお確かめ下さい。</p>
			</div>
		</section>
