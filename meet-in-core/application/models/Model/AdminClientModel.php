...
class AdminClientModel extends AbstractModel{
	...
	private $masterClientDict = array(
										...
										"negotiation_audio_text_remaining_hour" =>"10",
	...
	// プランの定義
	private $plan = array(
			array("id"=>0, "planName"=>"トライアル", 		"maxStaffCount"=>"3", 		"maxDocumentSize"=>"0"),
			array("id"=>1, "planName"=>"ライトプラン", 		"maxStaffCount"=>"3", 		"maxDocumentSize"=>"0"),
			array("id"=>7, "planName"=>"ライトプラン10", 	"maxStaffCount"=>"10", 		"maxDocumentSize"=>"5368709120"),
			array("id"=>2, "planName"=>"スタンダードプラン", 	"maxStaffCount"=>"30", 		"maxDocumentSize"=>"5368709120"),
			array("id"=>3, "planName"=>"スタンダード50", 		"maxStaffCount"=>"50", 		"maxDocumentSize"=>"10737418240"),
			array("id"=>4, "planName"=>"スタンダード100", 		"maxStaffCount"=>"100", 	"maxDocumentSize"=>"21474836480"),
			array("id"=>5, "planName"=>"スタンダード300", 		"maxStaffCount"=>"300", 	"maxDocumentSize"=>"32212254720"),
			array("id"=>6, "planName"=>"スタンダード1000", 	"maxStaffCount"=>"1000", 	"maxDocumentSize"=>"42949672960"),
			array("id"=>8, "planName"=>"スタンダード1300", 	"maxStaffCount"=>"1300", 	"maxDocumentSize"=>"42949672960"),
			array("id"=>99, "planName"=>"アイドマ社専用", 	"maxStaffCount"=>"1000", 	"maxDocumentSize"=>"107374182400")
	);
	...
	function masterClientValidation($data){
			$validationDict = array(
						...
						"client_redirect_url" 					=>array("name" =>"リダイレクト先", 			"length" => 100, 	"validate" => array(8)),
		...
		if(!in_array($data["plan"], $planIds)){
			...
			// 契約期間の入力チェック
			if ($data["contract_period_start_date"] >  $data["contract_period_end_date"]) {
