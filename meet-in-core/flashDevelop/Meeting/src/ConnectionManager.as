...
{		
	...
	public class ConnectionManager extends EventDispatcher
	{
		...
		public function register(rtmp:Boolean):void
		{
			...
			{
				trace("[ERROR]connectionManager - register : _host = " + _host + ", _application = " + _application + ", _user = " + _user + ", _meeting = " + _meeting);
			...
			try
			{
				...
				trace("[DEBUG]connectionManager - register - _connection.connect:" + protocol + _host + "/" + _application + ", user = " + _user + ", _meeting = " + _meeting);
			}
			catch (e:Error)
			{
				trace("[ERROR]connectionManager - register - _connection.connect:" + protocol + _host + "/" + _application + ", user = " + _user + ", _meeting = " + _meeting);
		...
		{	
			...
			ExternalInterface.call("meetinFlashTargetVideo_debug", "Connection status: " + e.info.code);
			...
			trace("[DEBUG]connectionManager - connectionHandler - e.info.code = " + e.info.code);
