...
if(!window.__b_release_mode){
    tsdp_api_add_js_scripts('head',
        '/webrtc/src/tinySDP/src/headers/tsdp_header_A.js',
        '/webrtc/src/tinySDP/src/headers/tsdp_header_C.js',
        '/webrtc/src/tinySDP/src/headers/tsdp_header_M.js',
        '/webrtc/src/tinySDP/src/headers/tsdp_header_O.js',
        '/webrtc/src/tinySDP/src/headers/tsdp_header_Str.js', // B, E, I, K, P, R, S, T, U, Z
        '/webrtc/src/tinySDP/src/headers/tsdp_header_V.js'
    );
}