...
<body>
	...
	if($to!=""){
	  $headers = "From: ".mb_encode_mimeheader("株式会社meet in") ."<ishii-ma@ishiijc.co.jp>\r\n";
	  ...
	  $message .= "MAIL：ishii-ma@ishiijc.co.jp\n\n";
	  ...
	  $re_to = 'ishii-ma@ishiijc.co.jp';
		// $re_to = 'ooshima@aidma-hd.jp';
	  $re_headers = "From: ".mb_encode_mimeheader("株式会社meetin{$_POST['confirm_type']}") ."<ishii-ma@ishiijc.co.jp>\r\n";
