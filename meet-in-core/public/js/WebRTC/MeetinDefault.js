...
const USER_PARAM_IS_CHROME_BOOK = isChromeBook(navigator.userAgent);
...
// frameRate: {max: 10}
var qvgaConstraints = {
  video: {width: {exact: 320}, height: {exact: 240}, frameRate: { min: 10, max: 15 }}
};
var vgaConstraints = {
  video: {width: {exact: 640}, height: {exact: 480}, frameRate: { min: 10, max: 15 }}
};
var svgaConstraints = {
  video: {width: {exact: 800}, height: {exact: 600}, frameRate: { min: 10, max: 15 }}
};
var hdConstraints = {
  video: {width: {exact: 1280}, height: {exact: 720}, frameRate: { min: 10, max: 15 }}
};
var fullHdConstraints = {
  video: {width: {exact: 1920}, height: {exact: 1080}, frameRate: { min: 10, max: 15 }}
};

// frameRate: {ideal: 10, max: 10}
var idealQvgaConstraints = {
video: {width: {ideal: 320, max: 1280}, height: {ideal: 240, max: 720}, frameRate: {ideal: 10, max: 15}}
//video: {width: {ideal: 288, max: 1280}, height: {ideal: 216, max: 720}, frameRate: {ideal:  9, max: 15}}
};
var idealVgaConstraints = {
video: {width: {ideal: 640, max: 1280}, height: {ideal: 480, max: 720}, frameRate: {ideal: 10, max: 15}}
//video: {width: {ideal: 576, max: 1280}, height: {ideal: 432, max: 720}, frameRate: {ideal:  9, max: 15}}
};
var idealSvgaConstraints = {
video: {width: {ideal: 800, max: 1280}, height: {ideal: 600, max: 720}, frameRate: {ideal: 10, max: 15}}
...
video: {width: {ideal: 1920, max: 1920}, height: {ideal: 1080, max: 1080}, frameRate: {ideal: 10, max: 15}}
