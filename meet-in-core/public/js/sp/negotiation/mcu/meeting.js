...
$(function() {
	...
	$(window).on("orientationchange resize", function(){
		...
		// 画面の向きが変わると、同時接続者達に送信する座標情報が狂ってしまうので初期化.
	...
	$('.non_reccomend_cancel').on('click', function() {
		$('.nonReccomendModal').css('display','none');
	});
...
// 	});
	...
	$(document).on('click', '#icon_copy_sentence', function(){
		...
		var copyMessage = [
			...
			"<br>",
			"時間になりましたら、下記URLよりルームにアクセスください。<br>",
			"招待者がログインするまで入室はできません。<br>",
			"",
			meetin_room_url+"<br>",
			"<br>",
