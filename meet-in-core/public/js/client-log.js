    ...
    $.ajax({
        ...
        $(link).click(function(){
            ...
            $(".connect-button").on('click',function(){
                ...
                $("#modal-content").hide();
                if(radio_select === '1') {
                    window.open('https://meet-in.jp/room/' + room + '/','_blank'); // 新しいタブを開き、ページを表示
                } else {
                    window.open('https://meet-in.jp/room/' + room + '?room_mode=2' , '_blank'); // 新しいタブを開き、ページを表示
                }
                $(".connect-button").off()
            });
        });
