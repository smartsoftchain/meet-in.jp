...
function receiveEContractJson(json){
  if (json.type == "INIT_E_CONTRACT"){
    ...
    $('#' + json.formId).prepend('<input type="text" id="' + json.partnerId + '" class="parts_inner_text_dammy text_form" style="width: ' + json.res.input.width + 'px; height: ' + json.res.input.height + 'px; font-size: ' + json.res.input.font_size + 'px; line-height: ' + json.res.input.font_size + 'px;">');
    if (json.partnerId == 0){
      // readonly 付与
    ...
    $('#' + json.formId + ' .done').remove();
    $('#' + json.formId + ' .text_form').remove();
    $('#' + json.formId).prepend('<textarea id="'+ json.partnerId +'" class="parts_inner_textarea_dammy text_form" style="width: ' + json.res.input.width + 'px; height: ' + json.res.input.height + 'px; font-size: ' + json.res.input.font_size + 'px; resize: none; line-height: ' + json.res.input.font_size + 'px;"></textarea>');
    if (json.partnerId == 0){
      // readonly 付与
