$('#submit_button').click(function(){
	...
	let make_tag ='<div class="mi_connect_input_wrap"><p class="mi_connect_input_title">接続はこちらから</p><input type="text" placeholder="ルーム名" id="mi_connect_input" /><button class="mi_connect_input_button" onclick=\'var meet_in_url = document.getElementById("mi_connect_input").value; window.open("https://meet-in.jp/room/'+ prefix +'" + meet_in_url, "_blank");\'>接続</button></div>';
