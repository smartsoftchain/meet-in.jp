...
<div id="chat_board_area" class="ui-widget-content chat_board_area">
	...
	<div class="chat_board_contents">
		...
		<div class="chat_board_head">
			<span class="icon-comment-02 mi_memo_icon" style="margin-left: 10px; font-size: 15px;">
		...
		<div class="chat_board_send_box">
			<textarea id="chat_board_send_message" class="chat_board_text" placeholder="メッセージを入力"></textarea>
			<div class="chat_board_flex_box">
				<input type="checkbox" id="select_sendMode_checkbox" checked="checked"><span class="chat_board_checkbox_text">Enterで送信</span>
