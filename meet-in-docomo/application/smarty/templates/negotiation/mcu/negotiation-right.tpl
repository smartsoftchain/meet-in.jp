  ...
  <div class="record_modal_message_wrap">
    <div class="record_message">
      ...
      <div style="margin-top:10px">
        有効にする方法は<a href="javascript:void(0);" onclick="window.open('/lp/faq/pdf/meet_in_record_how_to_enable.pdf', '_blank', 'location=yes,height=500,width=600,scrollbars=no,status=yes');" style="text-decoration:underline;">こちら</a>
      </div>
    </div>
