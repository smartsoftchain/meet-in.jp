        ...
        if(partnerId == 0){
          ...
          // テキストフォーム設定の場合
            ...
            $.ajax({
              ...
              $('#' + formId).prepend('<input type="text" id="0" class="parts_inner_text_dammy text_form" style="width: ' + res.input.width + 'px; height: ' + res.input.height + 'px; font-size: ' + res.input.font_size + 'px; line-height: ' + res.input.font_size + 'px;">');
          ...
          // テキストエリア設定の場合
            ...
            $.ajax({
              ...
              $('#' + formId + ' .done').remove();
              $('#' + formId + ' .text_form').remove();
              $('#' + formId).prepend('<textarea id="0" class="parts_inner_textarea_dammy text_form" style="width: ' + res.input.width + 'px; height: ' + res.input.height + 'px; font-size: ' + res.input.font_size + 'px; resize: none; line-height: ' + res.input.font_size + 'px;"></textarea>');
            ...
            if(res == 1 || res == 0) {
              ...
              // テキストフォーム設定の場合
                ...
                $.ajax({
                  ...
                  $('#' + formId + ' .done').remove();
                  $('#' + formId + ' .text_form').remove();
                  $('#' + formId).prepend('<input type="text" id="' + partnerId + '" class="parts_inner_text_dammy text_form" style="width: ' + res.input.width + 'px; height: ' + res.input.height + 'px; font-size: ' + res.input.font_size + 'px; line-height: ' + res.input.font_size + 'px;">');
              ...
              // テキストエリア設定の場合
                ...
                $.ajax({
                  ...
                  $('#' + formId + ' .done').remove();
                  $('#' + formId + ' .text_form').remove();
                  $('#' + formId).prepend('<textarea id="' + partnerId + '" class="parts_inner_textarea_dammy text_form" style="width: ' + res.input.width + 'px; height: ' + res.input.height + 'px; font-size: ' + res.input.font_size + 'px; resize: none; line-height: ' + res.input.font_size + 'px;"></textarea>');
                  //readonly 付与
