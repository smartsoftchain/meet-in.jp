...
<div id="mi_main_contents">
	...
	<div id="mi_content_area">
		...
		<div class="mi_content_title mgb_unset">
			<h1><span class="icon-folder mi_content_title_icon"></span>ウェビナーデフォルト設定</h1>
		</div>
		<!-- コンテンツタイトル end -->

		<!-- 説明領域 begin -->
		<div class="os_description_area">
			ウェビナーのデフォルト値を設定します。<br>
			TOPからウェビナーを作成した際、テンプレートを指定していない場合は下記の設定が反映されます。
		</div>
		<!-- 説明領域 end -->
		...
		{/if}
		<!-- メッセージ表示エリア end -->
		<form action="/open-seminar/default" method="post" id="openSeminar_form" enctype="multipart/form-data">
			<!-- テーブル start -->
