...
<div id="mi_main_contents">
	...
	<div id="mi_content_area">
		...
		<div class="mi_content_title mgb_unset">
			<h1><span class="icon-folder mi_content_title_icon"></span>ウェビナーリード詳細</h1>
		</div>
		<!-- コンテンツタイトル end -->

		<!-- タブ領域 begin -->
		<div class="webinar_detail_tab_area">
			<a href="/webinar-lead/behavior-history-list?id={$webinarLead.id}"><div class="webinar_detail_tab width120">行動履歴</div></a>
		...
		<form action="/webinar-lead/detail" method="post" id="webinar_lead_form">
			<!-- テーブル start -->
