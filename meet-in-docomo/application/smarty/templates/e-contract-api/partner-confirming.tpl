...
<div id="mi_main_contents">
  ...
  <div id="mi_content_area">
    ...
    <div class="mi_content_title">
      ...
      <h1>電子契約書一覧</h1>
      <div class="mi_flt-r">
        <form id="search_form" action="/e-contract-api/partner-confirming" method="get">
      ...
      <div class="button_wrap">
        <div class="button-box-confirming" id="button-box-confirming-id">
          <div class="confirming_button">
            <a href="https://{$serverAddress}/e-contract-api/partner-confirming"class="button_text-confirming">確認中　({$list->getCount()}件)</a>
          </div>
        </div>
        ...
        <div class="button-box-rejection" id="button-box-rejection-id">
          <div class="rejection_button">
            <a href="https://{$serverAddress}/e-contract-api/partner-canceled"class="button_text-rejection">却下　({$canceledCount}件)</a>
          </div>
        </div>
      </div>
    </div>
