...
<div id="mi_main_contents">
  ...
  <div id="mi_top_nav">
    ...
    <div class="mi_breadcrumb_list">
      ...
      <a href="/e-contract-api/confirming">電子契約書一覧</a>
    </div>
    <!-- パンくずリスト end -->
  </div>
  <!-- トップナビ end -->
      ...
      <div class="mi_flt-r">
        <div class="mi_content_title_option">
          ...
          <div class="mi_flt-r" style="display:flex">
            <form id="search_form_tag" action="/e-contract-api/confirming" method="get">
              <!-- TODO AHD-1935 -->
            ...
            <form id="search_form" action="/e-contract-api/confirming" method="get">
              <div class="search_box">
      ...
      <div class="button_wrap">
        <div class="button-box-confirming" id="button-box-confirming-id">
          <div class="confirming_button">
            <a href="https://{$serverAddress}/e-contract-api/confirming"class="button_text-confirming">確認中　({$list->getCount()}件)</a>
          </div>
        </div>
