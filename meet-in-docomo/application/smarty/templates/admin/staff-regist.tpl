...
function HowStaffChecked() {
	if((document.getElementById("admin_staff") && document.getElementById("admin_staff").checked) || (document.getElementById("part_time_staff") && document.getElementById("part_time_staff").checked)){
		if($(".general_authority_wrap")) {
...
.sample_label:before {
	...
	border-right: 2px solid #0081CC;	/* 境界線（右）のスタイルを指定する */
	border-bottom: 2px solid #0081CC;	/* 境界線（下）のスタイルを指定する */
	...
	<div id="mi_content_area">
		...
		<form action="/admin/staff-regist" method="post" id="staff_form" enctype="multipart/form-data">
			...
			<div class="mi_table_main_wrap mi_table_input_right_wrap_all">
				<table class="mi_table_input_right mi_table_main staff_table_main">
					<tbody>
						{if ($user.client_id != 0) && (($user.staff_id == $staffDict.staff_id) && ($user.staff_type == $staffDict.staff_type)) }
						<tr>
							...
							{*<td style="background-color: #0081CC;" class="mi_tabel_content">*}
						...
						<tr>
							...
							<td colspan="3" class="mi_tabel_content">
								<input type="text" class="f_name_ mi_default_input input_hidden" name="staff_firstname" value="{$staffDict.staff_firstname|escape}" autocomplete="off" placeholder="氏名"/>
						...
						<tr>
							...
							<td colspan="3" class="mi_tabel_content">
								<input type="text" class="f_name_ mi_default_input input_hidden" name="staff_firstnamepy" value="{$staffDict.staff_firstnamepy|escape}" autocomplete="off" placeholder="氏名(カナ)"/>
						...
						{* <tr>
							...
							<td colspan="3" class="mi_tabel_content ">
								...
								<input type="hidden" name="staff_authenticate_flg" value="" >
						...
						<tr>
							<th class="mi_check_td"></th>
							<th class="mi_tabel_title">ビジネスdアカウントID<span class="required">必須</span></th>
							<td colspan="3" class="mi_tabel_content">
								<input type="text" class="mi_default_input input_hidden" name="DocomoID" value="{$staffDict.DocomoID|escape}"/>
							</td>
						</tr>
						<tr>
							<th class="mi_check_td"></th>
							<th class="mi_tabel_title">アカウント識別子<span class="required">必須</span></th>
							<td colspan="3" class="mi_tabel_content">
								<input type="text" class="mi_default_input input_hidden" name="accountid" value="{$staffDict.accountid|escape}"/>
							</td>
						</tr>
						<tr>
							<th class="mi_check_td"></th>
							<th class="mi_tabel_title">連絡先メールアドレス<span class="required">必須</span></th>
							<td colspan="3" class="mi_tabel_content">
								<input type="text" class="mi_default_input input_hidden" name="dprofile_email" value="{$staffDict.dprofile_email|escape}"/>
							</td>
						</tr>
						{else}
						<input type="hidden" name="DocomoID" value="{$staffDict.DocomoID|escape}">
						<input type="hidden" name="accountid" value="{$staffDict.accountid|escape}">
						<input type="hidden" name="dprofile_email" value="{$staffDict.dprofile_email|escape}">
						{/if}
						<tr>
							<th class="mi_check_td"></th>
						...
						{* <tr>
							...
							<td colspan="3" class="mi_tabel_content">
								<input type="text" placeholder="CE99999" class="f_account mi_default_input input_hidden" name="salescrowd_id" value="{$staffDict.salescrowd_staff_type|escape}{$staffDict.salescrowd_staff_id|escape}"/>
							</td>
						</tr>
						<tr>
							<th class="mi_check_td"></th>
							...
							<td colspan="3" class="mi_tabel_content">
								<input type="password" class="f_account mi_default_input input_hidden" name="salescrowd_password"/>
							</td>
						</tr> *}
						{/if}
					</tbody>
