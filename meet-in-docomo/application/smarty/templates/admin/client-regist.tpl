			...
			<div class="mi_table_main_wrap mi_table_input_right_wrap">
				<table class="mi_table_input_right mi_table_main client_regist">
					<tbody>
						...
						<input type="hidden" name="two_factor_authenticate_flg" value="0">
			...
			<div class="mi_table_main_wrap mi_table_input_right_wrap">
				<table class="mi_table_input_right mi_table_main client_regist">
					<tbody>
							<tr>
								...
								<td class="mi_tabel_content">
									{foreach from=$plan item=row}
									  {if $row.id != 0}
										  <input type="radio" name="plan" id="plan_{$row.id}" value="{$row.id}" {if $row.id == 2}checked{/if}><label for="plan_{$row.id}">{$row.planName}</label>
										  <br>
										{/if}
									{/foreach}
								</td>
							...
							<input type="hidden" name="webinar_available_time" value="0">
							<tr>
