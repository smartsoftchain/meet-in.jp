...
$(function (){
	...
	$("*[name^=edit_]").click(function(){
		...
		var url = "/admin/home-staff-regist?staff_id=" + ids[1];
		...
		<div id="main_contents">
			...
			<div class="heading">
				<div class="pgtitle clearfix">
					<h3>在宅アカウント一覧</h3>
					<!--<h4><a href="#" class="btn-wht large"><span class="istar">新規登録</span></a></h4>-->
				</div>
				{if isset($registMsg)}
					<div class="errmsg">
						{$registMsg}
			...
			<div class="article-2clm clearfix">
					...
					<div class="searching over">
						<div class="input-area clearfix">
							<form action="/admin/home-staff-list" method="get" >
					...
					<table class="listtable th-c td-l">
						<thead>
							<tr>
								...
								<th class="sort">{$list->getOrderArrow('契約開始日', 'telework_start_date')}</th>
								<th class="sort">{$list->getOrderArrow('契約終了日', 'telework_end_date')}</th>
