...
class VideoModel extends AbstractModel
{
	...
	// /** レスポンスメッセージ */
	// const MSG_UPLOAD_ERROR          = '動画ファイルのアップロードに失敗しました。';
	// const MSG_UPLOAD_SUCCESS        = '動画ファイルのアップロードに成功しました。';
	// const MSG_CREATE_FILE_ERROR     = '動画ファイルの作成に失敗しました。';
	// const MSG_CREATE_FILE_SUCCESS   = '動画ファイルの作成に成功しました。';
	// const MSG_FILE_NOT_EXIST        = '動画ファイルは現在見つかりませんでした。';
	// const MSG_FILE_DOWNLOAD_SUCCESS = '動画ファイルのダウンロードに成功しました。';
