...
// add tinySAK API
tsip_api_add_js_scripts('head', '/webrtc/src/tinySAK/src/tsk_api.js');

// add tinyMEDIA API
tsip_api_add_js_scripts('head', '/webrtc/src/tinyMEDIA/src/tmedia_api.js');

// add tinySDP API
tsip_api_add_js_scripts('head', '/webrtc/src/tinySDP/src/tsdp_api.js');

// add tinySIP API
tsip_api_add_js_scripts('head',
'/webrtc/src/tinySIP/src/tsip_action.js',
'/webrtc/src/tinySIP/src/tsip_event.js',
'/webrtc/src/tinySIP/src/tsip_message.js',
'/webrtc/src/tinySIP/src/tsip_session.js',
'/webrtc/src/tinySIP/src/tsip_stack.js',
'/webrtc/src/tinySIP/src/tsip_timers.js',
'/webrtc/src/tinySIP/src/tsip_uri.js'
);
...
tsip_api_add_js_scripts('head',
'/webrtc/src/tinySIP/src/authentication/tsip_auth.js',
'/webrtc/src/tinySIP/src/authentication/tsip_challenge.js'
);

tsip_api_add_js_scripts('head', 
'/webrtc/src/tinySIP/src/dialogs/tsip_dialog.js',
...
'/webrtc/src/tinySIP/src/dialogs/tsip_dialog_layer.js'
...
tsip_api_add_js_scripts('head',
'/webrtc/src/tinySIP/src/headers/tsip_header.js'
...
tsip_api_add_js_scripts('head',
'/webrtc/src/tinySIP/src/parsers/tsip_parser_header.js'
...
tsip_api_add_js_scripts('head',
'/webrtc/src/tinySIP/src/transactions/tsip_transac.js'
...
tsip_api_add_js_scripts('head',
'/webrtc/src/tinySIP/src/transports/tsip_transport.js',
'/webrtc/src/tinySIP/src/transports/tsip_transport_layer.js'
);