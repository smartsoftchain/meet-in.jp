...
if(!window.__b_release_mode){
    tsip_api_add_js_scripts('head',
     '/webrtc/src/tinySIP/src/transactions/tsip_transac_ict.js',
     '/webrtc/src/tinySIP/src/transactions/tsip_transac_ist.js',
     '/webrtc/src/tinySIP/src/transactions/tsip_transac_layer.js',
     '/webrtc/src/tinySIP/src/transactions/tsip_transac_nict.js',
     '/webrtc/src/tinySIP/src/transactions/tsip_transac_nist.js'
    );
}
