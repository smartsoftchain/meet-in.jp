...
function connectNoPublish(peer_id) {
	var successCallback = function(data, textStatus, XMLHttpRequest) {
		if ("1" == data.result) {
			...
			$(".mail_to_btn").attr("data-mailtext","mailto:?subject=meet in招待のお知らせ&body=こんにちは。%0d%0a%0d%0a"+mailname+"さんからdXオンライン営業へ招待のご連絡です。%0d%0a【meet in番号】%0d%0a"+ connect_no +"%0d%0a%0d%0a【meet in接続方法】%0d%0a1）下記のURLよりmeet in公式サイトに移動します。%0d%0ahttps://meet-in.jp%0d%0a2）meet in番号入力フォームに、上記meet in番号と自分の名前（任意）を入力します。%0d%0a3）入力後、「接続」ボタンをクリックしてください。%0d%0a%0d%0a以上、今後ともよろしくお願い申し上げます。%0d%0a%0d%0ameet in運営事務局%0d%0ahttps://meet-in.jp%0d%0a");
