...
#define HTML_BEGIN_COMMON_RESPONSE(BINARYWRITER,TITLE) \
	{ BinaryWriter& __binary(BINARYWRITER); __binary.write(EXPAND("<!DOCTYPE HTML PUBLIC \"-//IETF//DTD HTML 2.0//EN\"><html><head><title>")).write(TITLE).write(EXPAND("</title>

</head><body><h1>")).write(TITLE).write(EXPAND("</h1><p>"));
